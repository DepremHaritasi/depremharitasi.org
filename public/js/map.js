    ...
    var p = {
        ...
        events: {
            ...
            circle_click: (circlePoint) => {
                let pointData = p.circleList.find(i => i.point.lat == circlePoint.lat && i.point.lng == circlePoint.lng)
        ...
        helpers: {
            ...
            getData: ()  => {
                ...
                console.log(center);
                fetch(`https://depremharitasi.org/data.json?lat=${center.lat}&long=${center.lng}`).then(p.events.data_received)
            },
            setMarkers: (data) => {
